...
Mixtral8x7B & \textbf{6.25} & 31.25 & \textbf{31.25} & 37.5 & \textbf{31.25} & 37.5 & 6.25 & \textbf{31.25} & 6.25 & 31.25 & \textbf{31.25}  & \textbf{50.0 } \\ 
Mistral Large & 0.0 & \textbf{37.5} & 6.25 & \textbf{37.5} & 12.5 & \textbf{56.25} & 0.0 & 25.0 & 12.5 & \textbf{37.5} & 12.5 & 43.75 \\ \hline
...
\caption{The percentage of anchored responses for all LLMs tested under the ZS prompting setup for the most difficult units of measure redefinitions ($R_{a}2$ and $R_{a}3$ levels). The highest rate for each model family is presented in \textbf{bold}.}
